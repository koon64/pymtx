...
class GradesClass:
    ...
    def grade_to_letter(self, grade):
        if 0 <= grade <= 100:
            structure = {
                93: 'A', 90: '-A', 89: 'B+', 86: 'B', 82: 'B-', 79: 'C+', 76: 'C', 72: 'C-', 69: 'D+', 66: 'D',
                62: 'D-',
                0: 'F'
            }
                ...
                if part_numb == 0:
                    ...
                    if address_number_suffix is None:
                        try:
                            ...
                            raise Exception(
                                "there has been an error parsing the address because there is no number in the begining of it. This could be due to an apartment number which are not currently supported")
                    ...
                    # print(part)
                part_numb += 1
            return Address(country, cid, states[state], state, locality, zip_code, street_name, address_number,
                           address_number_suffix, apt_number, po_box_number)
        else:
...
class Address:
    def __init__(self, country, cid, state, sid, locality, zip_code, street, number, number_suffix=None,
                 apt_number=None, po_box_number=None):
    ...
    def __str__(self):
        ...
        return "{}{}{} {}{}, {}, {} {}, {}".format(po_box_str, self.number, number_suffix_str, self.street,
                                                   apt_number_str, self.locality, self.sid, self.zip, self.cid)
